        ...
        <section class="formulario">
          <h3>Solicitud de vuelo</h3>
            ...
            <select name="selecttt" id="selecte" class="form-select" onclick="this.value">
              ...
              <select name="destin" id="s" class="form-select" onclick="muestraselect(this.value)" onchange="incrustarMapa()">
            ...
            <h5 class="m-2">Ida</h5>
            <input type="date" name="entrada" id="caja"  onclick="this.value">
            <h5 class="m-2">Regreso</h5>
            <input type="date" name="salida" id="caja2" onclick="this.value">
            <h5 class="m-2">Num personas</h5>
            <input class="form-control" type="number" placeholder="Seleccione el numero de personas" name="personas" min="0"  onchange="this.value" >
            <h5 class="m-2">Num habitaciones</h5>
            <input class="form-control" type="number" placeholder="Seleccione el numero de habitaciones" name="habitaciones" min="0"  onchange="this.value" >
            <div>
              <button style="float: left;" type="submit" class="btn btn-outline-secondary m-2">Agregar a mi canasta</button>
            </div>
            </form>
          ...
          <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel">
            ...
            <div class="offcanvas-body small">
              <?php
                  include("CRUD/solicitudpaquete.php");              
              ?>            
            </div>
          </div>
        </section>
		...
		function muestraselect(str){ 
			...
			conexion.onreadystatechange=function(){  
				if(conexion.readyState==4 && conexion.status==200){
					document.getElementById("dived").innerHTML=conexion.responseText; 
				}
			}
